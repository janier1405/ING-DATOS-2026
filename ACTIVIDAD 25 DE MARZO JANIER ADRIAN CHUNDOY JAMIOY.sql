...
stoProT as stock from productos where stoProT >= 25 or idproducto= 1; 

## between 
## select* from nombre_ tabla between valor1 and valor2 
## como utilizariamos esos metodos en consultas  
## minimo dos metodos tipo string varchar y dos metodos numericos
select *
from nombre_tabla
...
select*
from productos 
where precioProducto >= 50000 and  precioProducto <= 10000;
...
select nombreProducto, stoProdT as nombre_producto, stoProdT as stock
from productos
where stoProdT >= 15 and nombreProducto =´Laptop Pro`;
